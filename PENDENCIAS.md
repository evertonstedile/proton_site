...
| B2 | **Copy real** | **REAIS:** serviços (33, c/ escopo), números (371 projetos · 119 laudos · 70.400 m² · 11 anos), posicionamento hero/About (D16), processo (fluxo full-service: Viabilidade → Projeto → Aprovação & Regularização → Execução & Entrega), tagline oficial. Ainda placeholder: **manifesto, depoimentos**. | Home, internas |
