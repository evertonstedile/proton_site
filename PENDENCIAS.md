...
| B5 | **Canal de contato (leads)** | Site desacoplado do Proton OS (D14) → leads NÃO vão para o Proton OS. Form construído com validação; **escrita STUBBED**. Falta DECIDIR o mecanismo: WhatsApp (wa.me), e-mail (Resend/Formspree) e/ou Supabase standalone do site. Precisa do nº de WhatsApp e/ou e-mail destino. | `ContactForm.tsx` |
