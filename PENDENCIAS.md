...
| B2 | **Copy real** | **Serviços = COMPLETOS** (33 em 7 frentes, com descrição de escopo do catálogo + tagline oficial "Soluções completas em engenharia, arquitetura e regularização"). Ainda placeholder: manifesto, posicionamento (hero), about, processo, depoimentos, números. | Home, internas |
